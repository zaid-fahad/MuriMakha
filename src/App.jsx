    ...
    <div className="min-h-screen font-sans bg-[#FDF6E3] text-[#2c2c2c] selection:bg-[#F59E0B] selection:text-white pb-12">
      ...
      <div className="relative max-w-6xl mx-auto p-4 md:p-6 grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-12 flex items-center justify-between mb-2">
          <div className="bg-[#2c2c2c] text-[#F59E0B] px-6 py-3 rounded-tr-2xl rounded-bl-2xl shadow-[4px_4px_0px_0px_rgba(44,44,44,1)] transform -rotate-1">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <section className="bg-[#F59E0B] p-6 rounded-3xl shadow-[4px_4px_0px_0px_rgba(44,44,44,1)] border-4 border-[#2c2c2c] relative overflow-hidden group">
          ...
          <section className="bg-white p-6 rounded-3xl shadow-[4px_4px_0px_0px_rgba(44,44,44,1)] border-2 border-[#2c2c2c]">
            <h2 className="text-xl font-black uppercase tracking-wide text-[#2c2c2c] mb-4 flex items-center gap-2">
